/**
 * 
 * @api {get} /api/fruits Consultar Frutas
 * @apiName Consultar Frutas
 * @apiDescription Este servicio se encraga de listar todas las frutas que existen en el sistema
 * @apiGroup Frutas
 * @apiVersion  1.0.0
 *   
 * @apiSuccess (200) {Number} responseCode Código de respuesta interno de la aplicación
 * @apiSuccess (200) {Object[]} responseMessage Array de objetos que contiene el listado de frutas
 * @apiSuccess (200) {String} responseMessage.name Nombre de la fruta
 * @apiSuccess (200) {String} responseMessage.image Url de la imagen de la fruta
 * @apiSuccess (200) {String} responseMessage.price Costo de la fruta
 * 
 * 
...
async function editFruit(req, res) {
  try {
    ...
    console.log("===============Error editar fruta=====================");
    console.log("error: ", error);
    console.log("====================================");
    return res.status(500).json({
      responseCode: 1001,
